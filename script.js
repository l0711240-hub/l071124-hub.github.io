...
function renderWorldMap() {
    ...
    const svg = `
        <svg viewBox="0 0 800 600" style="width: 100%; height: 100%;">
            ...
            <!-- 북극해 -->
            <text x="400" y="30" text-anchor="middle" font-size="14" fill="#0288d1" font-weight="600">북극해</text>
            
            <!-- 노르덴 대륙 (북부) -->
            <rect x="300" y="50" width="200" height="80" fill="#b3e5fc" stroke="#0288d1" stroke-width="2" rx="5"/>
            <text x="400" y="85" text-anchor="middle" font-size="16" font-weight="600" fill="#01579b">노르덴</text>
            <text x="400" y="105" text-anchor="middle" font-size="12" fill="#01579b">🏔️ 한랭 기후</text>
            
            <!-- 중앙 해역 -->
            <text x="400" y="180" text-anchor="middle" font-size="14" fill="#0288d1" font-weight="600">중앙해</text>
            
            <!-- 시벤트 대륙 (서부) -->
            <rect x="50" y="200" width="180" height="100" fill="#81c784" stroke="#2e7d32" stroke-width="2" rx="5"/>
            <text x="140" y="240" text-anchor="middle" font-size="16" font-weight="600" fill="#1b5e20">시벤트</text>
            <text x="140" y="260" text-anchor="middle" font-size="12" fill="#1b5e20">⚓ 온대 기후</text>
            
            <!-- 오리엔탈 대륙 (동부) -->
            <rect x="570" y="200" width="180" height="100" fill="#fff59d" stroke="#f57c00" stroke-width="2" rx="5"/>
            <text x="660" y="240" text-anchor="middle" font-size="16" font-weight="600" fill="#e65100">오리엔탈</text>
            <text x="660" y="260" text-anchor="middle" font-size="12" fill="#e65100">📚 아열대</text>
            
            <!-- 아스트랄 대륙 (중부 남쪽) - 본부 -->
            <rect x="280" y="350" width="240" height="120" fill="#ffccbc" stroke="#c62828" stroke-width="3" rx="5"/>
            <text x="400" y="390" text-anchor="middle" font-size="18" font-weight="700" fill="#b71c1c">아스트랄</text>
            <text x="400" y="410" text-anchor="middle" font-size="14" fill="#b71c1c">🏜️ 사막 기후</text>
            <text x="400" y="430" text-anchor="middle" font-size="16" font-weight="700" fill="#c62828">★ 모네타 본부</text>
            <text x="400" y="450" text-anchor="middle" font-size="12" fill="#d32f2f">고파 참사 발생지</text>
            
            <!-- 오스테라 대륙 (최남단) -->
            <rect x="320" y="500" width="160" height="80" fill="#ce93d8" stroke="#7b1fa2" stroke-width="2" rx="5"/>
            <text x="400" y="535" text-anchor="middle" font-size="16" font-weight="600" fill="#4a148c">오스테라</text>
            <text x="400" y="555" text-anchor="middle" font-size="12" fill="#4a148c">🌋 미지의 대륙</text>
            
            <!-- 연결선 -->
            <line x1="400" y1="130" x2="400" y2="200" stroke="#90a4ae" stroke-width="2" stroke-dasharray="5,5"/>
            <line x1="400" y1="300" x2="400" y2="350" stroke="#90a4ae" stroke-width="2" stroke-dasharray="5,5"/>
            <line x1="400" y1="470" x2="400" y2="500" stroke="#90a4ae" stroke-width="2" stroke-dasharray="5,5"/>
        </svg>
    `;
